<template>
  <el-menu router default-active="2" class="el-menu-vertical-demo" background-color="#334E66" text-color="#fff" active-text-color="#ffd04b">
    <el-submenu index="1">
      <template slot="title">
    ...
    <el-submenu index="3">
      ...
      <el-menu-item index="/admin/list">账户信息</el-menu-item>
    </el-submenu>
    <el-submenu index="4">
      <template slot="title">
    ...
    <el-submenu index="5">
      ...
      <el-menu-item index="/auth/role">菜单权限</el-menu-item>
    </el-submenu>
  </el-menu>
</template>
