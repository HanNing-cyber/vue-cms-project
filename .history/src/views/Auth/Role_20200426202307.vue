  ...
  <div class="cont clearfix">
    ...
    <div class="right-box">
      <el-card class="box-card">
        <div slot="header" class="header">
          <h3><i class="el-icon-collection-tag"></i>商品管理</h3>
      ...
      <el-card class="box-card">
        <div slot="header" class="header">
          <h3><i class="el-icon-collection-tag"></i>订单管理</h3>
          <el-switch v-model="value1"></el-switch>
        </div>
        <div class="switch-box">
          <span>商品分类</span>
      ...
      <el-card class="box-card">
        <div slot="header" class="header">
          <h3><i class="el-icon-collection-tag"></i>账户设置</h3>
          <el-switch v-model="value1"></el-switch>
        </div>
        <div class="switch-box">
          <span>商品分类</span>
      ...
      <el-card class="box-card">
        <div slot="header" class="header">
          <h3><i class="el-icon-collection-tag"></i>用户管理</h3>
          <el-switch v-model="value1"></el-switch>
        </div>
        <div class="switch-box">
          <span>商品分类</span>
      ...
      <el-card class="box-card">
        <div slot="header" class="header">
          <h3><i class="el-icon-collection-tag"></i>权限设置</h3>
          <el-switch v-model="value1"></el-switch>
        </div>
        <div class="switch-box">
          <span>商品分类</span>
