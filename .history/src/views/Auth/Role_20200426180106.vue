    ...
    <el-card class="box-card">
      ...
      <template>
        <el-table size="mini" :data="tableData" :default-sort="{ id: 'id' }">
          ...
          <!-- <el-table-column prop="role_name" label="标签" width="100" :filter-method="filterTag" filter-placement="bottom-end">
            <template slot-scope="scope">
              <el-tag size="mini" :type="scope.row.role_name === '超级管理员' ? 'danger' : ''" disable-transitions>{{ scope.row.role_name }}</el-tag>
            </template>
          </el-table-column> -->
