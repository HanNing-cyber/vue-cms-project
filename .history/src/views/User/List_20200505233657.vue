			...
			<el-table :data="tableData" :default-sort="{prop: 'date', order: 'descending'}">
				...
				<el-table-column label="操作" width="120px">
					<template slot-scope="scope">
						...
						<el-button icon="el-icon-edit" type="primary" plain class="btn" @click="openEditor(scope.row.id)"></el-button>
						<!-- </router-link> -->

						<el-button icon="el-icon-delete" @click="removeHandle(scope.row.id,scope.$index)" circle type="danger" plain></el-button>
					</template>
				</el-table-column>
			</el-table>
		</template>
