  ...
  <el-card class="box-card">
    ...
    <template>
      <el-table :data="tableData" :default-sort="{ prop: 'date', order: 'descending' }">
        ...
        <el-table-column prop="username" label="账号" sortable width="100"> </el-table-column>
        <el-table-column prop="fullname" label="姓名" sortable> </el-table-column>
        <el-table-column prop="sex" label="性别" sortable width="100"> </el-table-column>
        ...
        <el-table-column prop="login_count" label="登录次数" sortable width="100"> </el-table-column>
    ...
    <el-dialog title="修改信息" :visible.sync="editerVisible" width="40%">
      <el-form :model="editFrom" :rules="rules" ref="editFrom" label-width="80px">
        ...
        <el-form-item label="头像" prop="avatar">
          <el-upload class="avatar-uploader" :headers="headers" action="http://localhost:3003/api/upload/common" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
...
export default {
  data() {
    return {
      ...
      id: "",
      rules: {
        username: [{ type: "string", message: "请输入姓名", trigger: "blur" }],
        ...
        role: [{ message: "请选择权限", trigger: "change" }],
        avatar: [{ type: "string", message: "请添加图片！", trigger: "blur" }],
      },
    };
  },
  created() {
