<template>
  <el-card class="box-card">
    ...
    <el-pagination background layout=" prev, pager, next, jumper,total, sizes" :total="16" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage4" :page-sizes="[4, 8, 16, 32]" :page-size="4"> </el-pagination>
  </el-card>
</template>
