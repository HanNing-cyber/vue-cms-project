	...
	<el-card class="box-card">
		...
		<template>
			<el-table :data="tableData" :default-sort="{prop: 'date', order: 'descending'}">
				...
				<el-table-column label="操作" width="120px">
					<template slot-scope="scope">
						<el-button icon="el-icon-edit" size="mini" type="primary" plain class="btn" @click="openEditor(scope.row.id,scope.$index)"></el-button>
						<el-button icon="el-icon-delete" size="mini" @click="removeHandle(scope.row.id,scope.$index)" type="danger" plain></el-button>
					</template>
				</el-table-column>
			</el-table>
		</template>
		...
		<el-dialog title="修改信息" :visible.sync="editerVisible" width="40%">
			...
			<div slot="footer" class="dialog-footer">
				<el-button @click="editerVisible = false">取 消</el-button>
